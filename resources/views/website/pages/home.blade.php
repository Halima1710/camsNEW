    ...
    <div class="carousel-item active">
      <div class="row">
				    <div class="col-sm-1">
				    	...
				    	<div class="line"><img src="{{url('frontend/images/linr-icon.png')}}"></div>
				    	<p class="number_tetx">02/3</p>
				    	<div class="left_img"><img src="{{url('frontend/images/img-2.png')}}"></div>
				    </div>
				    <div class="col-sm-5">
				    ...
				    <div class="col-sm-6">
				    	<div><img src="{{url('frontend/images/img-1.png')}}"></div>
				    </div>
			    </div>
    </div>
		...
		<div class="container">
			...
			<div class="about_bg">
				<div class="row">
					...
					<div class="col-md-4">
						<div class="table_img"><img src="{{url('frontend/images/about-img.png')}}"></div>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="our_section_2">
		...
		<div class="images_section_2">
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="image_6"><img src="{{url('frontend/images/bed66.png')}}"></div>
				</div>
				<div class="col-sm-3">
		...
		<div class="container">
           <div id="my_carousel" class="carousel slide" data-ride="carousel">
			...
			<div class="testimonila_inner">
				<div class="testing_img"><img src="{{url('frontend/images/img-10.png')}}"></div>
    					...
    					<div class="row">
    						...
    						<div class="col-sm-6 col-lg-3">
    							<div class="social_icon">
    								<ul>
    									<li><img src="{{url('frontend/images/fb-icon.png')}}"></li>
    									<li><img src="{{url('frontend/images/twitter-icon.png')}}"></li>
    									<li><img src="{{url('frontend/images/in-icon.png')}}"></li>
    									<li><img src="{{url('frontend/images/instagram-icon.png')}}"></li>
    								</ul>
    							</div>
    						</div>
    					</div>
