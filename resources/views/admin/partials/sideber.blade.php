<section>
        ...
        <aside id="leftsidebar" class="sidebar">
            <!-- User Info -->
            <div class="user-info" style="background-image: url('/backend/images/profile.jpg')">
                <div class="image">
                    <img src="{{asset('backend/images/sweet.png')}}" width="48" height="48" alt="User" />
                </div>
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="flase5">Halima Khatun</div>
                    <div class="email">tishahalima95@gmail.com</div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="{{route('admin.furnitures.create')}}"> Furniture</a>
                                    </li>
                                    <li>
                                        <a href="{{route('admin.furnitures.list')}}"> Furniture List</a>
                                    </li>
                                    <li>
                                        <a href="{{route('admin.furniture.category')}}">Category</a>
                                   </li>
                                   <li>
                                       <a href="{{route('admin.furniture.categorylist')}}">Category List</a>
                                  </li>
                           ...
                           <li>
                            ...
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="{{route('admin.repairs.create')}}">Repairing work</a>
                                    </li>
                                    <li>
                                        <a href="{{route('admin.repairs.rlist')}}">Repairing List</a>
                         </li>           
                                </ul>
                            </li>
                        </ul>
                    ...
                    <li>
                        <a href="javascript:void(0);" class="menu-toggle">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M11 2l7.298 2.28a1 1 0 0 1 .702.955V7h2a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1l-3.22.001c-.387.51-.857.96-1.4 1.33L11 22l-5.38-3.668A6 6 0 0 1 3 13.374V5.235a1 1 0 0 1 .702-.954L11 2zm0 2.094L5 5.97v7.404a4 4 0 0 0 1.558 3.169l.189.136L11 19.58 14.782 17H10a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1h7V5.97l-6-1.876zM11 12v3h9v-3h-9zm0-2h9V9h-9v1z"/></svg>
                            <span>Payment</span>
                        </a>
                        <ul class="ml-menu">
                            <li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="{{route('admin.carpenter.carpentercreate')}}">Carpenter Information</a>
                            </li>
                            <li>
                                <a href="{{route('admin.carpenter.carpenterlist')}}">Carpenter Information List</a>
                            </li>
